...
public enum ItemType {
	...
	private ItemType(int nukkit) {
		this.nukkit = nukkit;
	}
	
	public static ItemType valueOf(int nukkit) {
		for (ItemType t : ItemType.values()) {
			if (t.getNukkit() == nukkit) return t;
		}
		return AIR;
	}
	...
	public static ArrayList<String> getStringValues() {
		...
		for (ItemType t : ItemType.values()) types.add(t.name());
		
		return types;
	}
	
	public int getNukkit() {
		return this.nukkit;
	}
	...
	public String toString() {
		return this.name() + "(" + this.nukkit + ", " + this.bukkit + ")";
	}
}
